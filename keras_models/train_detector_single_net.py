"""
python3 keras_models/train_detector.py
обучение детектора на основе только одной сети 128x128
уклон делается на повышенный miou
"""
import os
import sys
#import cv2
...
model_name = 'model_MobileNetV2_single'
